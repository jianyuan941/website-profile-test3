...
function TotalBonusYearSubmit2() {
    const bonusInput = g("#bonus12");
    const bonusInput2 = g("#bonus22");
...
function bonusincome2(){
    ...
    const year = TotalBonusYearSubmit2() 
    ...
    ni(".bonus-analysis-year1-12", totalBonus);//send data to bonus income analysis table
    // ni(".bonus-analysis-year1-1", totalBonus);//send data to Applicants Analysis table
    ni(".bonus-analysis-year2-12", totalBonus);
    ni(".Sec-applicant-net-bonus-amount", totalBonus);
    ni(".bonus-income-variance-result2", variance);
    ni(".number-of-year-result2", year);
